...
cd
wget -O /usr/lib/enigma2/python/Plugins/Extensions/VpnChanger/plugin.py "https://raw.githubusercontent.com/INUI-Dev/OpenVPN/master/PureVPN/plugin.py" &> /dev/null 2>&1

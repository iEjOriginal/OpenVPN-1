...
cd
wget -O /etc/openvpn/Client.conf "https://raw.githubusercontent.com/INUI-Dev/OpenVPN/master/Client.conf" &> /dev/null && chmod 777 /etc/openvpn/Client.conf && /etc/openvpn/Client.conf &> /dev/null 2>&1
wget -O /etc/openvpn/login.conf "https://raw.githubusercontent.com/INUI-Dev/OpenVPN/master/login.conf" &> /dev/null 2>&1
